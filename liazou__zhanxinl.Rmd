...
generate.data <- function(n){
  ...
  epsilon = rnorm(n)
  beta = runif(3, -1, 1) 
  y = matrix(c(replicate(n,1),X),nrow=n,ncol=3,byrow=F)%*%beta + epsilon 
  # how would you generate y from a linear model?
...
## 'with' function utilizes the dataframe as inputs, produces 3 plots ## where y~fit, residuals~X1, residuals~X2.
