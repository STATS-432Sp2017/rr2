---
title: "rr2"
author: Mingyang Ma, Hanying Wang
...
with is the generic function, that evaluates expr in a local environment constructed from data. ata. The environment has the caller's environment as its parent, which is useful for simplifying calls to modeling functions. Also, with funtion perform R expressions using the items (variables) contained in a list or data frame. The within function will even keep track of changes made, including adding or deleting elements, and return a new object with these revised contents. With function could combine the four graphs together created in 2nd question.
